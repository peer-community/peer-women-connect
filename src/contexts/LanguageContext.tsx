...
const translations = {
  it: {
    ...
    'b2b.box3.text': 'Percorsi di formazione e sessioni interattive progettate per abbattere i tabù',
  ...
  en: {
    ...
    'b2b.box1.title': 'Training programs',
    'b2b.box1.text': 'Training programs',
    'b2b.box2.title': 'Innovative policies',
    'b2b.box2.text': 'Menopause, fertility, menstrual leave',
    'b2b.box3.title': 'Workshops',
    'b2b.box3.text': 'Training paths and interactive sessions designed to break taboos',
    'b2b.box4.title': 'Community',
    'b2b.box4.text': 'Connect your organization to our active and aware community',

...
const translations = {
  it: {
    ...
    'b2b.subtitle': 'Peer aiuta le aziende a supportare la salute femminile e a creare un ambiente di lavoro migliore con:',
    'b2b.box1.title': 'Politiche innovative',
    'b2b.box1.text': 'Menopausa, fertilità, congedo mestruale',
    'b2b.box2.title': 'Workshop',
    'b2b.box2.text': 'Percorsi di formazione e sessioni interattive progettate per abbattere i tabù',
  ...
  en: {
    ...
    'community.ctaTitle': 'Peer is coming!',
    'community.ctaDescription': 'Want a sneak peek of the launch? Join our waitlist',
    
    // B2B Section
    'b2b.title': 'Are you a company?',
    'b2b.subtitle': 'Peer helps companies support women\'s health and create a better workplace with:',
    'b2b.box1.title': 'Innovative policies',
    'b2b.box1.text': 'Menopause, fertility, menstrual leave',
    'b2b.box2.title': 'Workshops',
    'b2b.box2.text': 'Training paths and interactive sessions designed to break taboos',
    'b2b.box3.title': 'Community',
    'b2b.box3.text': 'Connect your organization to our active and aware community',
    'b2b.partner.title': 'Partner with Peer',
